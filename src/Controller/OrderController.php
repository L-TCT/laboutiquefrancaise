...
class OrderController extends AbstractController
{
     ...
     */
    public function index(Request $request,Cart $cart,ProductRepository $productRepository): Response
    {
     ...
     */
    public function add(Request $request,Cart $cart,ProductRepository $productRepository): Response
    {
